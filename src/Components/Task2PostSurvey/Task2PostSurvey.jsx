...
import styles from "./Task2PostSurvey.module.css";
import { useNavigate } from "react-router-dom";
import { useSurvey } from "../../surveyIDContext";

function Task2PostSurvey() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    console.log("Submitting Task 2 post-survey data:", formData);
    ...
    try {
      ...
      console.log("Task 2 post-survey submitted successfully:", responseData);
      navigate("/AUT_gpt", { state: { task: 3 } }); // Navigate to AUT_gpt with task 3
    } catch (error) {
      console.error("Error submitting Task 2 post-survey:", error);
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Task 2 Feedback</h1>
...
export default Task2PostSurvey;
